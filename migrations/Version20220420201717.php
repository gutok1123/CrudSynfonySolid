 ...
 */
final class Version20220420201717 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE register_entity (id INT AUTO_INCREMENT NOT NULL, student_id INT DEFAULT NULL, student_account_id INT DEFAULT NULL, courses_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_BD983C82CB944F1A (student_id), UNIQUE INDEX UNIQ_BD983C8276B4B25B (student_account_id), INDEX IDX_BD983C82F9295384 (courses_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
